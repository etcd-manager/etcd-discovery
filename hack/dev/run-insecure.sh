...
# ---------------------------------------------------------------------
/opt/etcd-v3.2.18-linux-amd64/etcdctl member add infra2 http://127.0.0.2:2380
...
$ /opt/etcd-v3.2.18-linux-amd64/etcdctl member list
...
# ---------------------------------------------------------------------
$ /opt/etcd-v3.2.18-linux-amd64/etcdctl member add infra3 http://127.0.0.3:2380
